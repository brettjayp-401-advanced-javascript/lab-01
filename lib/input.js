...
const inputSchema = require('./inputSchema.js')

// class Input {
//   constructor(args){
//     this.command = {};
//     this.formatted = minimist(args);
//     this.objectKeyArray = Object.keys(this.formatted);
//     this.validator = new Validator(inputSchema);
//   };

//   valid(){
//     return this.validator.validate({key: this.key, val: this.val})
//   };
// }
...
//   check(){
//     for(let i = 0; i < this.objectKeyArray.length; i++) {
//       let key = this.objectKeyArray[i];
//       let val = this.formatted[key];
//       switch(key) {
//       case 'a':
//       case 'add':
